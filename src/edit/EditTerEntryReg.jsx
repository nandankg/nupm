...
import { addTEREntry, editData, fetchData } from "../reducer/TER_Entry_Reducer";
import { formatTime } from "../data/formatDate";
import { FilterDrama } from "@mui/icons-material";

const Ter_entry_register_edit = () => {
    ...
    console.log(terentry.data.data);
    const [items, setItems] = useState([]);
    const itmm = terentry.data.data;
    console.log(items);

    useEffect(() => {
        dispatch(fetchData());
        setItems(terentry.data.data);
    }, []);
                        ...
                        <div className="col-md-8 form-container">
                            <form onSubmit={handleSubmit}>
                                <div className=" mb-3 form-heading-container">
                                    <h3 className="form-heading"> Edit TER Entry Register</h3>
                                ...
                                <div className="row mb-3">
                                    ...
                                    <div className="col-md-3">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                setFormValues({ ...formValues, ex_time: e.target.value })
                                            }
                                        />
                                    </div>
                                    <div className="col-md-3">
...
export default Ter_entry_register_edit;