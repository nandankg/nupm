...
import { fetchData, editData } from "../../reducer/akshra/BiodataRegReducer";
...
const EditBioreg = () => {
  ...
  console.log(BIodataregList.data.data);
  const [items, setItems] = useState([]);
  const itmm = BIodataregList.data.data;
  console.log(items);
  useEffect(() => {
    dispatch(fetchData());
    setItems(BIodataregList.data.data);
  }, []);
  useEffect(() => {
    setItems(BIodataregList.data.data);
  }, [BIodataregList]);
          ...
          <div className="col-md-8 form-container">
            <form onSubmit={handleSubmit}>
              <div className=" mb-3 form-heading-container">
                <h3 className="form-heading"> EDIT: BIO DATA REGISTER</h3>
