...
const EditControlTakenOver = () => {
  ...
  const itmm = ControltakenoverList.data.data;
  console.log(items);
  useEffect(() => {
    if (ControltakenoverList) {
...
export default EditControlTakenOver;
