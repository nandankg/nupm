...
import {  editData, fetchData } from '../../reducer/isha/AFCPREVENTIVEMAINTENANCECHECKLISTtvmhalfyearlyREducer';
import { Breadcrumbs } from '@mui/material';
import stationData from "../../station.json";
const EditAFCPREVENTIVEMAINTENANCECHECKLISTtvmhalfyearly = () => {
          ...
          <div className="form-container" style={{ marginLeft: "0", marginRight: "0", maxWidth: "98%" }}>
            ...
            <form onSubmit={handleSubmit}>
              <div className=" mb-3 form-heading-container">
                <h3 className="form-heading">EDIT : AFC PREVENTIVE MAINTENANCE CHECKLIST (TVM HALF YEARLY)</h3>
              ...
              <div className='row mb-3'>
                ...
                <label className="col-md-9" style={{ textAlign: "center" }}>TVM</label>
...
export default EditAFCPREVENTIVEMAINTENANCECHECKLISTtvmhalfyearly;