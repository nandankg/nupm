...
import { editData, fetchData } from "../reducer/AfcPreventReducer";
import stations from "../data/station.json";



const AfcAnnexure_A_Edit = () => {
    ...
    const latsvdudrill = useSelector((state) => state.afcpreventchkformstate || []);
                ...
                <form onSubmit={handleSubmit}>
                  <div className=" mb-3 form-heading-container">
                    <h3 className="form-heading">
                      EDIT AFC Prevent Maintenance Checklist (Monthly) (Annexure-A)
                    </h3>
    ...
    {stations.map((station,index) => station["Station Name"]&& (
...
export default AfcAnnexure_A_Edit;