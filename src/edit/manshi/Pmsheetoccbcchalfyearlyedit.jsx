...
const Pmsheetoccbcchalfyearlyedit = () => {
  ...
  useEffect(() => {
    if (pmsheetoccbccData.data && pmsheetoccbccData.data.data) {
      setItems(pmsheetoccbccData.data.data);
    }
  }, [pmsheetoccbccData]);
      ...
      <div className="container">
        <div role="presentation" className="bredcrumbs">
          <Breadcrumbs aria-label="breadcrumb">
            <Link to={`/list/${slug}`}>PM Sheet (OCC & BCC) Half Yearly</Link>
...
export default Pmsheetoccbcchalfyearlyedit;
