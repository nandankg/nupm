...
import { editData, fetchData } from "../reducer/AfcPreAnnexureBReducer";

const AfcAnnexureBEdit = () => {
  ...
  const latsvdudrill = useSelector((state) => state.afcannexurestate || []);
            ...
            <form onSubmit={handleSubmit}>
              <div className=" mb-3 form-heading-container">
                <h3 className="form-heading">
                  Edit AFC Prevent Maintenance Checklist (Half Yearly) (Annexure-BB)
                </h3>
...
export default AfcAnnexureBEdit;
