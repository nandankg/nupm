    ...
    activities2: [
      {
        ...
        avm5: fd.avm5,
        avm6: fd.avm6,
        remarkavm: fd.remarkavm,
        actionavm: fd.actionavm,
        deficiencyavm: fd.deficiencyavm,
      },
    ],
    ...
    activities3: [
      {
        ...
        swt5: fd.swt5,
        swt6: fd.swt6,
        remarkswt: fd.remarkswt,
        actionswt: fd.actionswt,
        deficiencyswt: fd.deficiencyswt,
      },
    ],
        ...
        <div role="presentation " className="bredcrumbs">
          <Breadcrumbs aria-label="breadcrumb">
            <Link underline="hover" color="inherit">
              AFC PREVENTIVE MAINTENANCE CHECKLIST (HALF YEARLY) (ANNEXURE-BB)
            </Link>
            <Link underline="hover" color="inherit">
              Register
            </Link>
