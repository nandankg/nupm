...
import { terentryregister } from "../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="TER_Entry_List.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={terentryregister}
        fileName="TER_Entry_List.xlsx"
      />
      {/* Pagination */}
      <Pagination
