...
import { incidentregister } from "../../data/tableColumns";
...
const IncidentRegisterSignalsList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> Incident Register Signals</h1>
      ...
      <PDFExportComponent
        ...
        filename="IncidentRegisterSignalsList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={incidentregister}
        fileName="IncidentRegisterSignalsList.xlsx"
      />
      {/* Pagination */}
      <Pagination
