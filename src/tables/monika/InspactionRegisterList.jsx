...
import { inspectionregister } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="InspactionRegisterList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={inspectionregister}
        fileName="InspactionRegisterList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default InspactionRegisterList;
