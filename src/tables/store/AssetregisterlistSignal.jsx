...
import { assetRegister } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="AssetregisterlistSignal.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={assetRegister}
        fileName="AssetregisterlistSignal.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default AssetregisterlistSignal;
