...
import { equipmentfailureocc } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="EquipmentFailureOccView.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={equipmentfailureocc}
        fileName="EquipmentFailureOccView.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default EquipmentFailureOccView;
