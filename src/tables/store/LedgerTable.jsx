...
import { fetchData } from "../../reducer/store/LedgerReducer";
...
import { ledgerregister } from "../../data/tableColumns";
...
console.log(user);
let deprt = user?.department;

const LedgerTable = () => {
  const dispatch = useDispatch();

  const [slug, setSlug] = useState(getLastParameter().trim());
  const attendance = useSelector((state) => state.ledger);
