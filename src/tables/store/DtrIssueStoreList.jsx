...
import { dtrIssue } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="DtrIssueStoreList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={dtrIssue}
        fileName="DtrIssueStoreList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default DtrIssueStoreList;
