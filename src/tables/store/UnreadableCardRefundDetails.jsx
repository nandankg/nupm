...
import { unreadablecard } from "../../data/tableColumns";
...
const UnreadableCardRefundDetails = () => {
  ...
  return (
    <>
     <div className="container mt-5">
      <h1>Unreadable Card Refund Details</h1>
       {/* Filter Bar */}
       <ReusableFilterBar
      ...
      <PDFExportComponent
        ...
        filename="unreadablecard.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={unreadablecard}
        fileName="unreadablecard.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default UnreadableCardRefundDetails;
