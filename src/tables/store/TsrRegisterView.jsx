...
import { tsrregisterdata } from "../../data/tableColumns";
    ...
    <>
     <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="tsrregisterdata.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={tsrregisterdata}
        fileName="tsrregisterdata.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default TsrRegisterView;
