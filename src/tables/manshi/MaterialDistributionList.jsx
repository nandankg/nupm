...
import { materialdistributiontotrainees } from "../../data/tableColumns";
...
const MaterialDistributionList = () => {
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    const newData = filterTableData(
      ...
      fromDate,
      toDate,
      materialdistributiontotrainees
    );
  ...
  <h1>Material Distribution</h1>
      ...
      {/* Table Structure */}
      <TableStructure
        columns={materialdistributiontotrainees}
      ...
      <PDFExportComponent
        ...
        filename="MaterialDistributionList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={materialdistributiontotrainees}
        fileName="MaterialDistributionList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default MaterialDistributionList;
