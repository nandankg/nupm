...
import { contractorWork } from "../../data/tableColumns";
...
const Contractor_Work_Done_List = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="Contractor_Work_Done_List.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={contractorWork}
        fileName="Contractor_Work_Done_List.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default Contractor_Work_Done_List;
