...
import { fetchData, saveData } from "../../reducer/manshi/PossesionReducer";
import { possessionregister } from "../../data/tableColumns";
...
const PossessionRegisterList = () => {
 const dispatch = useDispatch();
   const [slug, setSlug] = useState(getLastParameter().trim());
   const possesionr = useSelector((state) => state.possession);
    ...
    <>
     <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="PossessionRegister.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={possessionregister}
        fileName="PossessionRegister.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default PossessionRegisterList;
