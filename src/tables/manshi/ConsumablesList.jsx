...
import { consumablesregistermainline } from "../../data/tableColumns";
...
const ConsumablesList = () => {
  ...
  <h1>Consumables List</h1>
      ...
      {/* Table Structure */}
      <TableStructure
        columns={consumablesregistermainline}
      ...
      <PDFExportComponent
        ...
        filename="ConsumablesList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={consumablesregistermainline}
        fileName="ConsumablesList.xlsx"
      />
      {/* Pagination */}
      <Pagination
