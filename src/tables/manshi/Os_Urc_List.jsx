...
import { urcandosentryregistersdc } from "../../data/tableColumns";
...
useEffect(() => {
  ...
  return (
    <div className="container mt-5">
      ...
      {/* Table Structure */}
      <TableStructure
        columns={urcandosentryregistersdc}
      ...
      <PDFExportComponent
        ...
        filename="Os_Urc_List.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={urcandosentryregistersdc}
        fileName="Os_Urc_List.xlsx"
      />
      {/* Pagination */}
      <Pagination
