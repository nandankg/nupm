...
import { fetchData, saveData } from "../../reducer/manshi/DailyTelecomReducer";
...
const DailyTelecomList = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const { id } = location.state;
  console.log(id);
  const tableRef = useRef(null);
  const { toPDF, targetRef } = usePDF({ filename: "DailyTelecom.pdf" });
                ...
                <table className="table" ref={tableRef}>
                  <thead>
                    <tr>
                      ...
                      <th colSpan={7}>{item.station}</th>
                      <th style={{ width: "250px" }} colSpan={12}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td colSpan={8} className="text-start">
                        1.Check and clear alarms in PIDS-PAS HMI 8 &nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[0]?.activities?.[0]?.checked ===
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[0]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <br />
                        <hr className="m-0" />
                        3.Checking of PAS equipment in TER & PF&nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[0]?.activities?.[2]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[7]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                    ...
                    <tr>
                      ...
                      <td colSpan={8} className="text-start">
                        1.Check for alarm indications in DSW, ASW & CCTV SWITCH
                        &nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[1]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <br />
                        <hr className="m-0" />
                        2.Visual Inspection of LED Status of DSW, ASW & CCTV
                        SWITCH&nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[1]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[8]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                    ...
                    <tr>
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[2]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[2]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[2]?.activities?.[2]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <br />
                        <hr className="m-0" />
                        4.Check platform monitor working &nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[2]?.activities?.[3]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <br />
                        <hr className="m-0" />
                        4.Check both recording of all camera is available for
                        both main and redundant &nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[2]?.activities?.[4]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[9]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[9]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[9]?.activities?.[2]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[9]?.activities?.[3]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[9]?.activities?.[4]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[9]?.activities?.[5]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                    ...
                    <tr>
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[3]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <br />
                        <hr className="m-0" />
                        2.Check working of Platform clocks & Analog clocks&nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[3]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[10]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[10]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[10]?.activities?.[2]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                    ...
                    <tr>
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[4]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[4]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[11]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[11]?.activities?.[2]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                    ...
                    <tr>
                      ...
                      <td colSpan={2}>ACS</td>
                      <td colSpan={8} className="text-start">
                        1.Check the display of AMC-1 & AMC-2&nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[5]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <br />
                        <hr className="m-0" />
                        2.Check LED Status of PSU of AMC & EML of all door&nbsp;
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[5]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[12]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[12]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[12]?.activities?.[2]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                    ...
                    <tr>
                      ...
                      <td colSpan={8} className="text-start">
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[6]?.activities?.[0]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
                        ...
                        <input
                          type="checkbox"
                          checked={
                            item?.systems?.[6]?.activities?.[1]?.checked ==
                            "yes"
                              ? true
                              : false
                          }
...
export default DailyTelecomList;
