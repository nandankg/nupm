...
import { honorariumregister } from "../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="HonoriumRegList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={honorariumregister}
        fileName="HonoriumRegList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default HonoriumRegList;
