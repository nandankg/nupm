...
import { listofhonorariumregisters } from "../data/tableColumns";
...
useEffect(() => {
  ...
  return (
    <div className="container mt-5">
      ...
      {/* Table Structure */}
      <TableStructure
        columns={listofhonorariumregisters}
      ...
      <PDFExportComponent
        ...
        filename="List Honorarium Register.pdf"
      />
...
export default ListHonoriumRegList;
