...
import { contractualsparetestingregister } from "../../data/tableColumns";
...
const ContractualSpareTestingTable = () => {
...
useEffect(() => {
  ...
  useEffect(() => {
    const newData = filterTableData(
      ...
      fromDate,
      toDate,
      contractualsparetestingregister
    );
  ...
  return (
    <div className="container mt-5">
      <h1> Contractual Spare Testing  </h1>
      ...
      {/* Table Structure */}
      <TableStructure
        columns={contractualsparetestingregister}
      ...
      <PDFExportComponent
        ...
        filename="Contractual.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={contractualsparetestingregister}
        fileName="Contractual.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default ContractualSpareTestingTable;
