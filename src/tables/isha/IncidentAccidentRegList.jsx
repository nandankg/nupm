...
import {  crewincidentaccident } from "../../data/tableColumns";
...
const   IncidentAccidentRegList = () => {
  ...
  return (
    <div className="container mt-5">
     <h1>Incident/Accident Register List</h1>
      ...
      <PDFExportComponent
        ...
        filename="  IncidentAccidentRegList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={   crewincidentaccident}
        fileName="  IncidentAccidentRegList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default   IncidentAccidentRegList;
