...
import {
  fetchData,
  saveData,
} from "../../reducer/isha/AFCPREVENTIVEMAINTENANCECHECKLISTtvmhalfyearlyREducer";

const AFCPREVENTIVEMAINTENANCECHECKLISTtvmhalfyearlyTable = () => {
  ...
  const { toPDF, targetRef } = usePDF({
    filename:
      "  AFC PREVENTIVE MAINTENANCE CHECKLIST (TVM HALF YEARLY)_Table.pdf",
  });
  ...
  return (
    <>
      <div className="container">
        ...
        <h3>
          {" "}
          AFC PREVENTIVE MAINTENANCE CHECKLIST (TVM HALF YEARLY) (ANNEXURE-B)
        </h3>
        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex align-items-center gap-3">
            <div className="d-flex gap-3">
              ...
              <DownloadTableExcel
                filename=" AFC PREVENTIVE MAINTENANCE CHECKLIST (TVM HALF YEARLY)_Table"
                sheet="  AFC PREVENTIVE MAINTENANCE CHECKLIST (TVM HALF YEARLY)_Table"
...
export default AFCPREVENTIVEMAINTENANCECHECKLISTtvmhalfyearlyTable;
