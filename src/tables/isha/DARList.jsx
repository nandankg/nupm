...
import { dar } from "../../data/tableColumns";
...
const DARList = () => {
 ...
 useEffect(() => {
  ...
  useEffect(() => {
    const newData = filterTableData(items, searchValue, fromDate, toDate, dar);
  ...
  return (
    <div className="container mt-5">
      ...
      {/* Table Structure */}
      <TableStructure columns={dar} currentItems={currentItems} slug={slug} />
