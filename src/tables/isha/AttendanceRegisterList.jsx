...
import { attendanceregister } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="ATTENDANCE REGISTER_Table.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={attendanceregister}
        fileName="ATTENDANCE REGISTER_Table.xlsx"
      />
      {/* Pagination */}
      <Pagination
