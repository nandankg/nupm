...
import { dailytransactionregistermainline } from "../../data/tableColumns";
...
const DailyTransactionRegisterList_RECEIPTS = () => {
...
useEffect(() => {
  ...
  useEffect(() => {
    const newData = filterTableData(
      ...
      fromDate,
      toDate,
      dailytransactionregistermainline
    );
  ...
  return (
    <div className="container mt-5">
      <h1> Daily Transaction Register Receipt </h1>
      ...
      {/* Table Structure */}
      <TableStructure
        columns={dailytransactionregistermainline}
      ...
      <PDFExportComponent
        ...
        filename="DTR Mainline.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={dailytransactionregistermainline}
        fileName="DTR Mainline.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default DailyTransactionRegisterList_RECEIPTS;
