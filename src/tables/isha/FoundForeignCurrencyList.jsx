...
import { foundreceivedforeigncurrency } from "../../data/tableColumns";
  ...
  return (
    <>
     <div className="container mt-5">
      ...
      {/* Table Structure */}
      <ReusableTableMC
        headers={foundreceivedforeigncurrency}
        data={currentItems}
        slug={slug}
      />
      ...
      <PDFExportComponent
        ...
        filename="foundreceivedforeigncurrency.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={foundreceivedforeigncurrency}
        fileName="foundreceivedforeigncurrency.xlsx"
      />
      {/* Pagination */}
      <Pagination
