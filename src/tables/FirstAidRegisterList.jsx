...
import { firstaidregister } from "../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="FirstAidRegisterList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={firstaidregister}
        fileName="FirstAidRegisterList.xlsx"
      />
      {/* Pagination */}
      <Pagination
