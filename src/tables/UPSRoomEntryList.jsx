...
import { upsroomentry } from "../data/tableColumns";
...
const UPS_Room_Entry_Register_List = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="UPS_Room_Entry_Register_List.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={upsroomentry}
        fileName="UPS_Room_Entry_Register_List.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default UPS_Room_Entry_Register_List;
