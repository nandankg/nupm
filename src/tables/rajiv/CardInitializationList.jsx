...
import { CardInitializationCol } from "../../data/tableColumns";
...
const CardInitializationList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> Card Initialization Tender Sdc</h1>
      ...
      <ExcelExportComponent
        data={currentItems}
        columns={CardInitializationCol}
        fileName="CardInitializationList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default CardInitializationList;
