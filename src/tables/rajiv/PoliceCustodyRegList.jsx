...
import { policecustodycol } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="PoliceCustody.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={policecustodycol}
        fileName="PoliceCustody.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default PoliceCustodyRegList;
