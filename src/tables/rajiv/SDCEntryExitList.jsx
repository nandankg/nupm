...
import { sdcentryexitcol } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename=" SDC Entry Exit List.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={sdcentryexitcol}
        fileName="SDCEntryExit .xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default SDCEntryExitList;
