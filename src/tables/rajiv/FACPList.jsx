...
import { nightfacpdrillregsiter } from "../../data/tableColumns";
 ...
 useEffect(() => {
  ...
  return (
    <div className="container mt-5">
      ...
      {/* Table Structure */}
      <ReusableTableMC
        headers={nightfacpdrillregsiter}
        data={currentItems}
        slug={slug}
      />
      ...
      <PDFExportComponent
        ...
        filename="FACPList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={nightfacpdrillregsiter}
        fileName="FACPList.xlsx"
      />
      {/* Pagination */}
      <Pagination
