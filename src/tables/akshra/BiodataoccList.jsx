...
import { biodatareg } from "../../data/tableColumns";
    ...
    <div className="container mt-5">
     <h1>BIO DATA REGISTER (OCC)</h1>
      ...
      <PDFExportComponent
        ...
        filename=" BiodataRegList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={  biodatareg}
        fileName=" BiodataRegList.xlsx"
      />
      {/* Pagination */}
      <Pagination
