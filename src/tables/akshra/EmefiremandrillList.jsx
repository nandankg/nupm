...
import { emergencyfireman } from "../../data/tableColumns";
...
useEffect(() => {
  ...
  return (
    <div className="container mt-5">
      <h1>  EMERGENCY/FIREMAN EXIT DRILL REGISTER</h1>
      ...
      <PDFExportComponent
        ...
        filename="Emefiremandrill.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={emergencyfireman}
        fileName="Emefiremandrill.xlsx"
      />
      {/* Pagination */}
      <Pagination
