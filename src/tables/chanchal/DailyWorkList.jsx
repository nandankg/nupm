...
import { dailyworkdoneregister } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="DailyWorkList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={dailyworkdoneregister}
        fileName="DailyWorkList.xlsx"
      />
      {/* Pagination */}
      <Pagination
