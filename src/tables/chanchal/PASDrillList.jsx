...
import { pidspasdrill } from "../../data/tableColumns";
    ...
    <div className="container mt-5">
     <h1> PIDS/PAS Drill</h1>
      ...
      <PDFExportComponent
        ...
        filename=" PASDrillList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={  pidspasdrill}
        fileName=" PASDrillList.xlsx"
      />
      {/* Pagination */}
      <Pagination
