...
import { fetchData, saveData } from "../../reducer/pinki/PMLogBookSDCReducer";
...
const PMLogBookListSDC = () => {
  ...
  //     const empid = row.emp_id ? row.emp_id.toLowerCase() : "";
  ...
  return (
    <>
      <div className="container">
        ...
        <h3> PREVENTIVE MAINTENACE WORKSHEET OF SDC SERVERS ( HALF YEARLY) </h3>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[0]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[1]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[2]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[3]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[4]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[5]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[6]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[7]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[8]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[9]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[10]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
                  ...
                  <tr>
                    ...
                    <td>{renderTickCross(item?.activities1?.[11]?.MWYA_SC)}</td>
                    <td>
                      {renderTickCross(
