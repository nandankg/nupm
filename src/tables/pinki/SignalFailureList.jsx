...
import { signalfailure } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="CBTTrainingList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={signalfailure}
        fileName="CBTTrainingList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default SignalFailureList;
