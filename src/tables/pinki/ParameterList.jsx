...
import { parameterregistersdc } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="ParameterList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={parameterregistersdc}
        fileName="ParameterList.xlsx"
      />
      {/* Pagination */}
      <Pagination
