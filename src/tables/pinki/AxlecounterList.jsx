...
import { axlecounterresetregister } from "../../data/tableColumns";
...
const AxlecounterList = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      {/* Table Structure */}
      <TableStructure
        columns={axlecounterresetregister}
...
export default AxlecounterList;
