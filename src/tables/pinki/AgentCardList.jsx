...
import { agentcardregisterssdc } from "../../data/tableColumns";
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="AgentCardList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={agentcardregisterssdc}
        fileName="AgentCardList.xlsx"
      />
      {/* Pagination */}
      <Pagination
