...
import { fetchData } from "../../reducer/monika/PmLogBookMainlineReducer";
...
const PmLogBookMainlineLists = ({ PMbookMainline }) => {
            ...
            <tbody>
              {currentItems.map((itm, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <Link
                      to={`/view/pm-logbook-monthly-tvm-mainline`}
                      state={{ id: itm.id }}
...
export default PmLogBookMainlineLists;
