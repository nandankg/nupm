...
const MaintenanceScheduleLists = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>HALF YEARLY MAINTENANCE SCHEDULE</h1>
      ...
      <PDFExportComponent
        ...
        filename="MaintenanceSchedule.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="MaintenanceSchedule.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default MaintenanceScheduleLists;
