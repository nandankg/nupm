...
import { fetchData } from "../../reducer/monika/DailyTelecomMainReducer";
...
const DailyTelecomMainLists = ({ DailyTelecom }) => {
  ...
  // const udata = useSelector((state) => state[stationDiary].data);
  // console.log(udata);
  // console.log(slug);
  console.log(DailyTelecomMainList);
  ...
  return (
    <>
      <div className="container">
        ...
        <h3> Update Check list and PM_Station A-I </h3>
            ...
            <tbody>
              {currentItems.map((itm, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <Link
                      to={`/view/checklist-and-pm-depot`}
                      state={{ id: itm.id }}
...
export default DailyTelecomMainLists;
