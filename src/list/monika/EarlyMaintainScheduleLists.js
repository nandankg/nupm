...
const EarlyMaintainScheduleLists = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> YEARLY MAINTENANCE SCHEDULE</h1>
      ...
      <PDFExportComponent
        ...
        filename="EarlyMaintainSchedule.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="EarlyMaintainSchedule.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default EarlyMaintainScheduleLists;
