...
const ColorLightSignalling = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> COLOUR LIGHT SIGNAL MAINTENANCE RECORD QUARTERLY</h1>
      ...
      <PDFExportComponent
        ...
        filename="ColorLightSignalling.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="ColorLightSignalling.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default ColorLightSignalling;
