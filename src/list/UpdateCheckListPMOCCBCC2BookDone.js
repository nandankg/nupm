...
const UpdateCheckListPMOCCBCC2BookDone = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> Deport Maintenance (yearly) Schedule</h1>
      ...
      <PDFExportComponent
        ...
        filename="checklistoccbcc.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="checklistoccbcc.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default UpdateCheckListPMOCCBCC2BookDone;
