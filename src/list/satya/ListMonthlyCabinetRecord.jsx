...
const ListMonthlyCabinetRecord = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>ATS Cabinet Maintenance Records</h1>
      ...
      <PDFExportComponent
        ...
        filename="ListMonthlyCabinetRecord.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="ListMonthlyCabinetRecord.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default ListMonthlyCabinetRecord;
