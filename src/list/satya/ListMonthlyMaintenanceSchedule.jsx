...
const ListMonthlyMaintenanceSchedule = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>PM Sheet (OCC & BCC) Monthly</h1>
      ...
      <PDFExportComponent
        ...
        filename="ListMonthlyMaintenanceSchedule.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="ListMonthlyMaintenanceSchedule.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default ListMonthlyMaintenanceSchedule;
