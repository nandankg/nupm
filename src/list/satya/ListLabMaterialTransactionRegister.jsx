...
const ListLabMaterialTransactionRegister = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> LAB Material Transaction List</h1>
      ...
      <PDFExportComponent
        ...
        filename="ListLabMaterialTransactionRegister.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="ListLabMaterialTransactionRegister.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default ListLabMaterialTransactionRegister;
