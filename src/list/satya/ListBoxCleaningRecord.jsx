  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="ListBoxCleaningRecord.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="ListBoxCleaningRecord.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default ListBoxCleaningRecord;
