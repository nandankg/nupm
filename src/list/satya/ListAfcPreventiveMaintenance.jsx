...
const ListAfcPreventiveMaintenance = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>AFC Preventive Maintenance (Monthly) List </h1>
      ...
      <PDFExportComponent
        ...
        filename="ListAfcPreventiveMaintenance.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="ListAfcPreventiveMaintenance.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default ListAfcPreventiveMaintenance;
