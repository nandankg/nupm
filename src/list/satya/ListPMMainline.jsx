...
import { fetchData } from "../../reducer/satya/PMMainlineReducer";
...
const ListPMMainline = () => {
  ...
  const jobCardList = useSelector((state) => state.mainline);
