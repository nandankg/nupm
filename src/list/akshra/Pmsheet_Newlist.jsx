...
import {
  ...
  fetchData,
  saveData,
} from "../../reducer/akshra/PmsheetReducer";
...
const Pmsheet_NewList = ({ pmsheet }) => {
  ...
  useEffect(() => {
    if (PMsheetList.data && PMsheetList.data.data) {
      setItems(PMsheetList.data.data);
      setSlug(PMsheetList.slug);
      setFilteredItems(PMsheetList.data.data);
    }
  }, [PMsheetList]);
...
export default Pmsheet_NewList;
