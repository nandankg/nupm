  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="Earth_connectivity_list.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="Earth_connectivity_list.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default Earth_connectivity_list;
