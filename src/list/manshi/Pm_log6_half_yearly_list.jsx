...
const Pm_log6_half_yearly_list = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> Pm log Preventive Maintenance TOM (Half Yearly) List</h1>
      ...
      <PDFExportComponent
        ...
        filename="Pm_log6_half_yearly_list.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="Pm_log6_half_yearly_list.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default Pm_log6_half_yearly_list;
