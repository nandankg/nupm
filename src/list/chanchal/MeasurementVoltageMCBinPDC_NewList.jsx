...
const MeasurementVoltageMCBinPDC_NewList= () => {
  ...
  return (
    <div className="container mt-5">
      <h1> Measurement of Voltage at MCB in PDC SIX MONTHLY MAINTENANCE RECORD</h1>
      ...
      <PDFExportComponent
        ...
        filename="BoxCleaning_Outdoor_list.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="BoxCleaning_Outdoor_list.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default MeasurementVoltageMCBinPDC_NewList;
