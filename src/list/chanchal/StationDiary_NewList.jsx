...
const StationDiary_NewList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>STATION DIARY (SIGNALLING)</h1>
      ...
      <PDFExportComponent
        ...
        filename="StationDiary_NewList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="StationDiary_NewList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default StationDiary_NewList;
