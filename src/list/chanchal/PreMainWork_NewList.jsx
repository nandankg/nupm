...
const PreMainWork_NewList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> PREVENTIVE MAINTENACE WORKSHEET OF CENTRAL COMPUTER (YEARLY)</h1>
      ...
      <PDFExportComponent
        ...
        filename="PreMainWork_NewList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="PreMainWork_NewList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default PreMainWork_NewList;
