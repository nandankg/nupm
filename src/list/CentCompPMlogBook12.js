...
const CentCompPMlogBook12 = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> PREVENTIVE MAINTENANCE WORKSHEET OF CENTRAL COMPUTER(YEARLY)</h1>
      ...
      <PDFExportComponent
        ...
        filename="CentCompPMlogBook12.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="CentCompPMlogBook12.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default CentCompPMlogBook12;
