...
const QuarterlyTrainInspectionLists = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>Quarterly On-board ATC Underframe Inspection</h1>
      ...
      <PDFExportComponent
        ...
        filename="QuarterlyTrainInspectionLists.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="QuarterlyTrainInspectionLists.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default QuarterlyTrainInspectionLists;
