...
import { fetchData } from "../../reducer/rajiv/PMLogBookMainLine3Reducer";
...
const PMLogBookMainline3Lists = () => {
  const tableRef = useRef(null);
  const { toPDF, targetRef } = usePDF({
    filename: "pm-logbook-monthly-gate-mainline.pdf",
  });
  ...
  const jobCardList = useSelector((state) => state.PMLogBookMainLine3);
...
export default PMLogBookMainline3Lists;
