...
import { fetchData } from "../../reducer/rajiv/OperationStationDiaryReducer";
...
const OperationStationDiaryLists = () => {
  const tableRef = useRef(null);
  const { toPDF, targetRef } = usePDF({
    filename: "Operation Station Diary List.pdf",
  });
  ...
  const jobCardList = useSelector((state) => state.OperationStationDiary);
...
export default OperationStationDiaryLists;
