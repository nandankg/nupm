...
const PMLogBook3Lists = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> PREVENTIVE MAINTENACE WORKSHEET OF CENTRAL COMPUER (MONTYLY)</h1>
      ...
      <PDFExportComponent
        ...
        filename="PMLogBook3Lists.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="PMLogBook3Lists.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default PMLogBook3Lists;
