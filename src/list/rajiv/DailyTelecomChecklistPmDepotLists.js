...
const DailyTelecomCheckLIstDepotLists = () => {
  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="DailyTelecomCheckLIst.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="DailyTelecomCheckLIst.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default DailyTelecomCheckLIstDepotLists;
