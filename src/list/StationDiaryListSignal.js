...
import { fetchData } from "../reducer/StationDiaryReducer";
...
const StationDiaryListSignal = () => {
  ...
  const jobCardList = useSelector((state) => state.stationDiary || []);
...
export default StationDiaryListSignal;
