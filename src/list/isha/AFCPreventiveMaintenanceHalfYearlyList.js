...
const AfcPreventiveMaintenanceList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>AFC PREVENTIVE MAINTENANCE CHECKLIST (TOM HALF YEARLY)(ANNEXURE-B)</h1>
      ...
      <PDFExportComponent
        ...
        filename="AfcPreventiveMaintenanceList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="AfcPreventiveMaintenanceList.xlsx"
      />
      {/* Pagination */}
      <Pagination
