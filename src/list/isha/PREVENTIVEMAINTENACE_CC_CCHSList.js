...
const PREVENTIVEMAINTENACE_CC_CCHSList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>    PREVENTIVE MAINTENACE WORKSHEET OF CC/CCHS WORKSTATIONS, CC
      BIM,TIM & CPD ( HALF YEARLY)</h1>
      ...
      <PDFExportComponent
        ...
        filename="PREVENTIVEMAINTENACE_CC_CCHSList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="PREVENTIVEMAINTENACE_CC_CCHSList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default PREVENTIVEMAINTENACE_CC_CCHSList;
