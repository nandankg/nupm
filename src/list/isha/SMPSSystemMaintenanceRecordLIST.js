...
const SMPSSYSTEMMAINTENANCERECORDList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> SMPS SYSTEM MAINTENANCE RECORD (ANNEXURE-G)</h1>
      ...
      <PDFExportComponent
        ...
        filename="SMPSSYSTEMMAINTENANCERECORDList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="SMPSSYSTEMMAINTENANCERECORDList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default SMPSSYSTEMMAINTENANCERECORDList;
