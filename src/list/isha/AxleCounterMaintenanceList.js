...
const AxelCounteMaintenanceRecord = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> Axle Counter (ACS-2000) MAINTENANCE RECORD</h1>
      ...
      <PDFExportComponent
        ...
        filename="AxelCounteMaintenanceRecord.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="AxelCounteMaintenanceRecord.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default AxelCounteMaintenanceRecord;
