...
const FilterReplacementList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> Filter Replacement Half yearly MAINTENANCE RECORD</h1>
      ...
      <PDFExportComponent
        ...
        filename="FilterReplacementList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="FilterReplacementList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default FilterReplacementList;
