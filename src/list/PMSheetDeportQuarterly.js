...
import { fetchData } from "../reducer/PmSheetReducer";
import ReusableTable from "../component/ReusableTable";
const PMSheetDeportQuarterlyList = () => {
  const tableRef = useRef(null);
  const { toPDF, targetRef } = usePDF({ filename: "PM Sheet Quarterly.pdf" });
  ...
  const jobCardList = useSelector((state) => state.pmsheetstate || []);
        ...
        <div role="presentation " className="bredcrumbs">
          <Breadcrumbs aria-label="breadcrumb">
            <Link underline="hover" color="inherit">
              PM Sheet Quarterly Maintanance Schedule
            </Link>
            <Link underline="hover" color="inherit">
              List
            </Link>
...
export default PMSheetDeportQuarterlyList;
