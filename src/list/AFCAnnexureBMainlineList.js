...
import { listcolumn_two } from "../data/tableColumns";
...
const AFCAnnexureMainlineList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>AFC Preventive Maintenance-OTHERS(Half Yearly)</h1>
      ...
      <PDFExportComponent
        ...
        filename="AFCAnnexureMainlineList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumn_two}
        fileName="AFCAnnexureMainlineList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default AFCAnnexureMainlineList;
