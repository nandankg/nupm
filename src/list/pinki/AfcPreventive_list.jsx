...
const AfcPreventive_list = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> AFC Preventive Maintenance (Half Yearly)</h1>
      ...
      <PDFExportComponent
        ...
        filename="AfcPreventive_list.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumn_two}
        fileName="AfcPreventive_list.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default AfcPreventive_list;
