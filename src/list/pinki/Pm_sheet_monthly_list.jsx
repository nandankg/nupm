...
import { fetchData } from "../../reducer/pinki/PMsheetMonthlyDepotReducer";
...
const Pm_sheet_monthly_list = () => {
  ...
  const jobCardList = useSelector((state) => state.pmsheetmonthly || []);
...
export default Pm_sheet_monthly_list;
