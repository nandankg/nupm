  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="IncidentAccidentList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="IncidentAccidentList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default IncidentAccidentList;
