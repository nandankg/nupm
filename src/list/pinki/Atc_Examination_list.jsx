...
import { fetchData } from "../../reducer/pinki/AtcExaminationReducer";
...
const Atc_Examination_list = () => {
  const tableRef = useRef(null);
  const { toPDF, targetRef } = usePDF({ filename: "ATC_Examination_list.pdf" });
  ...
  const jobCardList = useSelector((state) => state.atcexamination || []);
...
export default Atc_Examination_list;
