...
const AFCPreventAnnexureAMainlineList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1> AFC Preventive Maintenance -Monthly (Others)</h1>
      ...
      <PDFExportComponent
        ...
        filename="AFCPreventAnnexureAMainlineList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="AFCPreventAnnexureAMainlineList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default AFCPreventAnnexureAMainlineList;
