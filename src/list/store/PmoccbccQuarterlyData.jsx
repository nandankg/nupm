...
const PmoccbccQuarterlyData = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>Pm Occ Bcc Quarterly List</h1>
      ...
      <PDFExportComponent
        ...
        filename="PmoccbccQuarterlyData.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="PmoccbccQuarterlyData.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default PmoccbccQuarterlyData;
