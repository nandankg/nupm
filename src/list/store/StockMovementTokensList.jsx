...
const StockMovementTokensList = () => {
  ...
  return (
    <div className="container mt-5">
      <h1>Stock Movement Tokens List</h1>
      ...
      <PDFExportComponent
        ...
        filename="StockMovementTokensList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="StockMovementTokensList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default StockMovementTokensList;
