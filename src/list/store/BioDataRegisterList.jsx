  ...
  return (
    <div className="container mt-5">
      ...
      <PDFExportComponent
        ...
        filename="BioDataRegisterList.pdf"
      />
      <ExcelExportComponent
        data={currentItems}
        columns={listcolumns}
        fileName="BioDataRegisterList.xlsx"
      />
      {/* Pagination */}
      <Pagination
...
export default BioDataRegisterList;
