...
const pmFollowupSheetSlice = createSlice({
  name: "pmFollowupSheet",
  initialState: {
    data: [],
    loading: false,
    error: null,
...
export const { clearState } = pmFollowupSheetSlice.actions;
export const addData = saveData; // Alias for compatibility
export default pmFollowupSheetSlice.reducer;