...
const FoundCashRegisterForm = () => {
  ...
  return (
    <OperationFormLayout 
      title="Details Related to Found/Received Cash"
      description="Register and track found cash with proper witness and security procedures"
    >
      <Form onSubmit={handleSubmit}>
        ...
        {/* Cash Details */}
        <div className="form-section">
          <h5 className="section-title">Cash Details</h5>
          <Row>
            <Col md={4}>
              <UniversalOperationFormField
                type="number"
                ...
                onChange={(value) => handleChange("cashAmount", value)}
                min="0"
                step="0.01"
                required
                error={errors.cashAmount}
                helpText="Total amount found"
              />
            </Col>
            <Col md={4}>
              <UniversalOperationFormField
            ...
            <Col md={4}>
              <UniversalOperationFormField
                ...
                helpText="e.g., 10x500, 5x200, 20x100"
              />
            </Col>
          </Row>
          <Row>
          ...
          <UniversalOperationFormField
            ...
            helpText="Condition of cash and container"
          />
        </div>
        ...
        <div className="form-section">
          ...
          <Row>
            <Col md={6}>
              <UniversalOperationFormField
                ...
                helpText="Required for cash handling"
              />
            </Col>
            <Col md={6}>
              <UniversalOperationFormField
          ...
          <UniversalOperationFormField
            ...
            helpText="Safe/vault where cash is stored"
          />
        </div>

        {/* Bank Deposit Information */}
        <div className="form-section">
          <h5 className="section-title">Bank Deposit Information</h5>
          <Row>
            <Col md={6}>
              <UniversalOperationFormField
                type="date"
            ...
            <Col md={6}>
              <UniversalOperationFormField
                ...
                helpText="Bank receipt/reference number"
              />
            </Col>
          </Row>
        </div>
          ...
          <Row>
            ...
            <Col md={6}>
              <UniversalOperationFormField
                ...
                helpText="Name of person who claimed the cash"
              />
            </Col>
          </Row>
          <Row>
        ...
        <div className="form-section">
          ...
          <UniversalOperationFormField
            ...
            rows={3}
            helpText="Security procedures followed, any unusual circumstances"
          />
        </div>

        <div className="form-actions">
          <Button type="submit" variant="primary">
            Save Found Cash Record
          </Button>
        </div>
      </Form>
    </OperationFormLayout>
...
export default FoundCashRegisterForm;