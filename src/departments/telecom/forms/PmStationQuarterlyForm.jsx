...
const PmStationQuarterlyForm = () => {
    ...
    systems: [
      {
        ...
        name: "PAS System",
        activities: [
          { id: 1, label: "Checking of HMI functionalities", checked: "no", remark: "" },
          { 
            id: 2, 
            label: "Making Live announcements", 
            checked: "no", 
            remark: "",
            readings: { hmiNormal: "", hmiEmergency: "" }
          },
          { id: 3, label: "Message recording, preview and announcement: HMI Emergency", checked: "no", remark: "" },
          { id: 4, label: "Message Scheduling & Repetition", checked: "no", remark: "" },
          { id: 5, label: "Check message origin status in HMI", checked: "no", remark: "" },
          { id: 6, label: "Cleaning of all ANS as per the recommendation", checked: "no", remark: "" },
          { id: 7, label: "External cleaning of speakers at all Zones", checked: "no", remark: "" },
          { id: 8, label: "Perform disk defragmentation and restart HMI", checked: "no", remark: "" },
          { id: 9, label: "Cleaning of external surface of display boards", checked: "no", remark: "" },
          { id: 10, label: "Login individual SWs for Alarms", checked: "no", remark: "" }
        ]
      },
      {
        id: 2,
        name: "PIDS System",
        activities: [
          { id: 1, label: "Cleaning of external surface of display boards", checked: "no", remark: "" }
        ]
      },
      {
        id: 3,
        name: "FOTS System",
        activities: [
          { id: 1, label: "Check Redundant power supply status of DSW", checked: "no", remark: "" },
          { 
            id: 2, 
      ...
      },
      {
        ...
        activities: [
          { id: 1, label: "Testing of Emergency telephone in tunnel", checked: "no", remark: "" },
          { id: 2, label: "Physical inspection of IDF & MDF", checked: "no", remark: "" },
          { id: 3, label: "External cleaning of all Platform monitors", checked: "no", remark: "" }
        ]
      },
      {
        id: 5,
        name: "CCTV System",
        activities: [
          { id: 1, label: "Check for Focusing & alignment of all cameras in Platform, Concourse, Staff & Entry/Exit Areas", checked: "no", remark: "" },
          { 
            id: 2, 
          ...
          { id: 3, label: "Check network ping test of MCL, K & SMCLK", checked: "no", remark: "" },
          { 
            id: 4, 
      ...
      },
      {
        ...
        name: "Clock System",
        activities: [
          { id: 1, label: "Check the tightness of nuts which holds the clocks (Platform)", checked: "no", remark: "" },
          { id: 2, label: "Check for Correctness/tightness of MCBs", checked: "no", remark: "" }
        ]
      },
      {
        id: 7,
      ...
      },
      {
        ...
        name: "ACS System",
        activities: [
          { id: 1, label: "Verify the Buzzer functioning", checked: "no", remark: "" }
        ]
      },
      {
        id: 9,
        name: "UPS System",
        activities: [
          { id: 1, label: "Load Test of Battery Bank-1 & Battery Bank-2", checked: "no", remark: "" }
        ]
      },
      {
        id: 10,
  ...
  return (
    <TelecomFormLayout title="PM Station Quarterly Maintenance Schedule" onSubmit={handleSubmit} loading={loading}>
              ...
              <tbody>
                {system.activities.map((activity, activityIndex) => (
                  <tr key={`${system.id}-${activity.id}`}>
                    <td>{activityIndex === 0 ? system.name : ''}</td>
                    <td>
                      {activity.label}
                      {activity.readings && (
                        <div className="mt-2">
