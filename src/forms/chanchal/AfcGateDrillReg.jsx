...
const AfcGateDrillReg = () => {
  ...
  const AfcGateDrillList = useSelector((state) => state.afcGateDrill);
          ...
          <div className="col-md-8 form-container">
            <form onSubmit={handleSubmit}>
              <div className=" mb-3 form-heading-container">
                <h3 className="form-heading">AFC GATE DRILL Register</h3>
...
export default AfcGateDrillReg;
