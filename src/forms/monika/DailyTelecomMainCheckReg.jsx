    ...
    systems: [
      {
        ...
        activities: [
          ...
          {
            id: 2,
            label: "2.Checking of PAS equipment in TER",
            checked: "no",
          },
        ],
      },
      {
        ...
        activities: [
          {
            id: 1,
            label: "1.Check for alarm indications in DSW and ASW",
            checked: "no",
          },
          {
            id: 2,
            label: "Visual Inspection of LED Status of DSW ASW ",
            checked: "no",
          },
        ],
      },
      ...
      },
      {
        ...
        activities: [
          {
            id: 1,
            label: "1.Check the Status of Controller",
            checked: "no",
          },
          {
            id: 2,
            label: "2.Check LED Status of PSU of AMC & EML ",
            checked: "no",
          },
        ],
      },
    ...
    <div className="container">
      <div role="presentation" className="bredcrumbs">
        <Breadcrumbs aria-label="breadcrumb">
          <Link>Update Check list and PM_Station A-I</Link>
...
export default DailTelecomMainCheckReg;
