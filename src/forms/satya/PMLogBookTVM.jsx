...
import { addData, addLogbook } from "../../reducer/satya/PMLogBookTVMReducer";
            ...
            <form onSubmit={handleSubmit}>
              <div className=" mb-3 form-heading-container">
                <h3 className="form-heading">
                  PREVENTIVE MAINTENACE WORKSHEET OF TVM, RCTM & AVM ( HALF
                  YEARLY)
                </h3>
              ...
              <div className="row mb-3">
                ...
                <label className="col-md-2 " style={{ textAlign: "left", marginLeft:"30px" }}>
                  TVM &nbsp;RCTM&nbsp;AVM
                </label>
                <label className="col-md-6" style={{ textAlign: "left" }}>
                  Remarks
...
const equipp=["TPNR TVM", "MWYA RCTM", "TPNR AVM"];
  return (
    <div className="row mb-3">
          ...
          <div className="d-flex gap-10 justify-content-between">
            {["TPNR1", "TPNR2", "TPNR3"].map((g,iddx) => (
              <div key={g}>
                ...
                />
                <label style={{fontSize:10}}>{equipp[iddx]}</label>
              </div>
            ))}
          </div>
