...
import { addAfcPreAnnB, addData } from "../reducer/AfcPreAnnexureBReducer";

const AfcAnnexureBform = () => {
    ...
    const handleInputChangesswt = (
        workKeyswt, indexswt, keyswt, value = null) => {
    ...
    const labelswt = [
        "Check Fixing & Alignment of all modules of Switches Rack",
        "Checking of all Cable connection and dressing",
        "Check Internal fan status of Switches",
        "Cleaning of Switches Rack and its fan",
...
console.log(formValues);
                    ...
                    >
                        <form onSubmit={handleSubmit}>
                            <div className=" mb-3 form-heading-container">
                                <h3 className="form-heading">AFC Preventive Maintenance-OTHERS(Half Yearly) (Annexure-B)</h3>
                    ...
                    {stations.map(
                      (station, index) =>
                        station["Station Name"] && (
                          <option key={index} value={station["Station Name"]}>
                            {station["Station Name"]}
                          </option>
                        )
                    )}
    ...
    <option value="DEC">December (DEC)</option>
                            ...
                            <div className='row mb-3'>
                                ...
                                <label className="col-md-9" style={{ textAlign: "center" }}>SC</label>
                                <label className='col-md-6' style={{ textAlign: "left" }}>Remarks</label>
                                <label className='col-md-3' style={{ textAlign: "left" }}>Action Taken</label>
                            ...
                            <div className='row mb-3'>
                                <label className='col-md-4' style={{ textAlign: "left" }}>Description</label>
                                <label className="col-md-9" style={{ textAlign: "center" }}>AVM</label>
                                <label className='col-md-6' style={{ textAlign: "left" }}>Remarks</label>
                                <label className='col-md-3' style={{ textAlign: "left" }}>Action Taken</label>
                                <label className='col-md-7' style={{ textAlign: "left" }}>Deficiency</label>
                            </div>
                            ...
                            <div className='row mb-3'>
                                <label className='col-md-4' style={{ textAlign: "left" }}>Description</label>
                                <label className="col-md-9" style={{ textAlign: "center" }}>SWITCHES</label>
                                <label className='col-md-6' style={{ textAlign: "left" }}>Remarks</label>
                                <label className='col-md-3' style={{ textAlign: "left" }}>Action Taken</label>
                                <label className='col-md-7' style={{ textAlign: "left" }}>Deficiency</label>
                            </div>
...
const FormSection1 = ({
    ...
    const isAllSelected = [
        ...
        "avm5",
        "avm6",
    ].every((avm) => formValues[workKeyavm][indexavm][avm] == "yes");
    return (
        <div className="row mb-3">
            <div className="col-md-7">
                <div className="d-flex align-items-start justify-content-between gap-3">
                    ...
                    <div className="d-flex gap-4 justify-content-between">
                        {["avm1", "avm2", "avm3", "avm4", "avm5", "avm6"].map(
                            (avm) => (
                                <div keys={avm}>
                                    <input
                                        type="checkbox"
                                        ...
                                        onChange={() => handleInputChangeavm(workKeyavm, indexavm, avm)}
                                    />
                    ...
                    <div className="col-md-4">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                handleInputChangeavm(workKeyavm, indexavm, "remarkavm", e.target.value)
                            }
                        />
                    </div>
                    <div className="col-md-4">
                        <input
                            ...
                            onChange={(e) =>
                                handleInputChangeavm(workKeyavm, indexavm, "actionavm", e.target.value)
                            }
                        />
                    </div>
                    <div className="col-md-4">
                        <input
                            ...
                            onChange={(e) =>
                                handleInputChangeavm(workKeyavm, indexavm, "deficiencyavm", e.target.value)
                            }
                        />
                    </div>
...
const FormSection2 = ({
    ...
    const isAllSelected = [
        ...
        "swt5",
        "swt6",
    ].every((swt) => formValues[workKeyswt][indexswt][swt] == "yes");
    const handleCheckboxChange = (swt) => {
        handleInputChangeswt(workKeyswt, indexswt, swt, formValues[workKeyswt][indexswt][swt] == "yes" ? "NO" : "yes");
    };
    return (
        <div className="row mb-3">
            <div className="col-md-7">
                <div className="d-flex align-items-start justify-content-between gap-3">
                    ...
                    <div className="d-flex gap-4 justify-content-between" >
                        {["swt1", "swt2", "swt3", "swt4", "swt5", "swt6"].map(
                            (swt) => (
                                <div key={swt}>
                                    <input
                                        type="checkbox"
                                        ...
                                        onChange={() => handleInputChangeswt(workKeyswt, indexswt, swt)}
                                    />
                    ...
                    <div className="col-md-4">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                handleInputChangeswt(workKeyswt, indexswt, "remarkswt", e.target.value)
                            }
                        />
                    </div>
                    <div className="col-md-4">
                        ...
                        <input
                            ...
                            onChange={(e) =>
                                handleInputChangeswt(workKeyswt, indexswt, "actionswt", e.target.value)
                            }
                        />
                    </div>
                    <div className="col-md-4">
                        <input
                            ...
                            onChange={(e) =>
                                handleInputChangeswt(workKeyswt, indexswt, "deficiencyswt", e.target.value)
                            }
                        />
                    </div>
                </div>
...
export default AfcAnnexureBform;
