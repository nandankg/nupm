...
const handleSystemChange = (e) => {
  ...
  const handleSubmit = (event) => {
    ...
    if (!formValues.station || !formValues.system || !formValues.location) {
      alert('Please fill all required fields: Station, System, and Location');
      return;
    }
    ...
    try {
      ...
      dispatch(addAssetRegister(submitData));
      const newSrno = sNo + 1;
      setSNo(newSrno);
          ...
          <div className="col-md-8 form-container">
            <form onSubmit={handleSubmit}>
              <div className=" mb-3 form-heading-container">
                <h3 className="form-heading">ASSET REGISTER</h3>
                ...
                <div className="col-md-6">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormValues({
                        ...formValues,
                        DescriptionOfMaterial: e.target.value,
                      })
                    }
                  />
                </div>
                <div className="col-md-6">
                  <label for="inputmake" className="form-label">
                    Make
                  </label>
                  <input
                    type="Text"
            ...
            <div className="col-md-6">
              ...
              <div className="row mb-3">
                <div className="col-4">
                  <label for="inputSerialNo" className="form-label">
                    Serial No.
                  </label>
                  <input
                    type="text"
                ...
                <div className="col-4">
                  <label for="inputQty" className="form-label">
                    QTY
                  </label>
                  <input
                    type="text"
              ...
              {/* Employee Details Auto-fill Section */}
              <div className="row mb-3">
                <div className="col-md-4">
                  <label for="inputEmployeeID" className="form-label">
                    Employee ID
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={(e) => {
                      ...
                      setFormValues({ 
                        ...formValues, 
                        employeeID: empID,
                        // Auto-fill employee name and designation based on ID
                        employeeName: empID ? `Employee ${empID}` : "",
                        designation: empID ? "Technician" : ""
                      });
                    }}
                  />
                </div>
