...
import {  editData, addData } from '../../reducer/isha/PREVENTIVEMAINTENACE_CC_CCHSReducer';
import { Breadcrumbs } from '@mui/material';
import { formatDate, formatTime } from "../../data/formatDate";
import stationData from "../../station.json";
const PREVENTIVEMAINTENACE_CC_CCHS = () => {
    ...
    <>
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="form-container" style={{ marginLeft: "0", marginRight: "0", maxWidth: "98%" }}>
        ...
        <span className="line-box" style={{width:"100%"}}></span>
            ...
            <div className='row mb-3'>
                ...
                <label className="col-md-9" style={{textAlign:"center"}}>CC/CCHS</label>
              </div>
              {labels.map((label, index) => (
               ...
               <div className='row mb-3'>
                <label className='col-md-4' style={{textAlign:"left"}}>Description</label>
                <label className="col-md-9" style={{textAlign:"center"}}></label>
...
const device=["CCWS-1", "CCWS-2", "CCWS-3", "CCWS-4", "CCWS-5", "CCWS-6", "CCWS-7", " CCHSWS-1", " CCHSWS-2", " CCHSWS-3"]
      ...
      <div className="col-md-12">
        <div className="d-flex align-items-start justify-content-between">
          ...
          <div className="d-flex gap-3 justify-content-between">
            {["CC1", "CC2", "CC3", "CC4", "CC5", "CC6", "CC7", "CCH1", "CCH2", "CCH3"].map(
              (g,ind) => (
                <div key={g}>
                  <input
                    type="checkbox"
                  ...
                  />
                  <label style={{fontSize:10}}>{device[ind]}</label>
                </div>
              )
            )}
          </div>
...
const FormSection1 = ({
  ...
  const dddds=["CC BIM-1", "CC BIM-2", "CC TIM", "CPD"]
  return (
    <div className="row mb-3">
            ...
            {["C1", "C2", "C3", "C4"].map(
              (c,indd) => (
                <div keys={c}>
                  ...
                  />
                  <label style={{fontSize:11}}>{dddds[indd]}</label>
                </div>
              )
            )}
          </div>
...
export default PREVENTIVEMAINTENACE_CC_CCHS;
