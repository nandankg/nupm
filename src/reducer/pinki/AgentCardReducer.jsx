...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/register/sdc/save", {
    ...
    body: JSON.stringify({
      ...
      date2: values.date2, // Replaced date with values.date
...
const agentcardslice = createSlice({
  name: "agentcard",
  initialState: {
    loading: false,
    data: [],
...
export const { addAgent } = agentcardslice.actions;
export default agentcardslice.reducer;
