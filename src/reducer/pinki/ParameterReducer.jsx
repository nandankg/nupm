...
export const saveData = createAsyncThunk("data/saveData", async (id) => {
  return fetch("https://tprosysit.com/upmrc/public/api/register/sdc/edit", {
    ...
    body: JSON.stringify({
      formType: "parameter-register-sdc",
      status: "1",
      update_id: id,
    }),
  }).then((res) => res.json());
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/register/sdc/save", {
    ...
    body: JSON.stringify({
      formType: "parameter-register-sdc",
      date: values.date,
      parameterversion: values.pversion,
      validityform: values.validityfrom,
      parameterdescription: values.pdescription,
      deviceupdated: values.deviceupdate,
      remarks: values.remark , //  added
      // station:values.station, //station
