...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/register/sdc/save", {
    ...
    body: JSON.stringify({
      ...
      staff1_name: user.name,
      staff1_desg: values.name,
      staff1_employee: user.profileid,
      staff1_sign: user.name,
      staff2_name: user.name,
      staff2_employee: "",
      staff2_desg: values.name,
      staff2_sign: user.name,
      staff3_name: user.name,
      staff3_desg: values.name,
      staff3_employee: "",
      staff3_sign: user.name,
...
export const editData = createAsyncThunk("data/editData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/register/sdc/edit", {
    ...
    body: JSON.stringify({
      ...
      staff1_name: user.name,
      staff1_desg: user.name,
      staff1_employee: "",
      staff1_sign: user.name,
      staff2_name: user.name,
      staff2_employee: "",
      staff2_desg: user.name,
      staff2_sign: user.name,
      staff3_name: user.name,
      staff3_desg: user.name,
      staff3_employee: "",
      staff3_sign: user.name,
...
export const { addLogBook } = pmlogbookSlice.actions;
