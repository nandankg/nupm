...
import { BoxCleaningData } from "../../data/Data";
  ...
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/signalling/save",
    {
      ...
      body: JSON.stringify({
        ...
        csign: values.csign,
        date_of_maintenance: values.date_of_maintenance,
        formType: "outdoor-box-cleaning",
...
const boxcleaningoutdoorslice = createSlice({
  name: "BoxCleaing",
  initialState: {
    loading: false,
    data: [],
...
export const { addBoxCleaning } = boxcleaningoutdoorslice.actions;
export default boxcleaningoutdoorslice.reducer;
