...
const fType = {
  ...
  mainline: "daily-transaction-register-mainline-issue",
  ...
  return fetch(
    `https://tprosysit.com/upmrc/public/api/register/${deprt}/save`,
    {
      ...
      body: JSON.stringify({
        ...
        issued_name: values.received_name,
        issued_designation: values.received_designation,
        formType: fType[dprt],
...
export const { dailyreceipt } = DailyIssueSlice.actions;
