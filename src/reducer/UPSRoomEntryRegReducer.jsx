...
const UPSRoomEntrySlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addUPSRoomEntry } = UPSRoomEntrySlice.actions;
export default UPSRoomEntrySlice.reducer;
