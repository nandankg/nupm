...
import { preMainWorkData } from "../../data/Data";
...
export const saveData = createAsyncThunk("data/saveData", async (id) => {
  return fetch("https://tprosysit.com/upmrc/public/api/register/sdc/edit", {
    ...
    body: JSON.stringify({
      formType: "pm-logbook-yearly1-sdc",
      status: "1",
      update_id: id,
    }),
  }).then((res) => res.json());
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/register/sdc/save", {
    ...
    body: JSON.stringify({
      ...
      activities: [
        {
          ServerRack: values.ServerRack,
          NetworkRack: values.NetworkRack,
          CCHSServerNetworkRack: values.CCHSServerNetworkRack,
...
const PreMainWorkReducerSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addPreMainWork } = PreMainWorkReducerSlice.actions;
export default PreMainWorkReducerSlice.reducer;
