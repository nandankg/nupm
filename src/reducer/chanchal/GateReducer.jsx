...
import { gateData } from "../../data/Data";
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/save", {
    ...
    body: JSON.stringify({
      ...
      lift_no: values.sigofsc,
      mess_display_recorded: values.disrecorded,
      mess_display_created: values.discreated,
      mess_anounce_recorded: values.annorecorded,
      mess_anounce_manual: values.annomanual,
...
const GateReducerSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addGate } = GateReducerSlice.actions;
export default GateReducerSlice.reducer;
