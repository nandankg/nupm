...
import { dailyWorkData } from "../../data/Data";
  ...
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/signalling/save",
    {
      ...
      body: JSON.stringify({
        ...
        MaintenanceActivity: values.MaintenanceActivity,
        Supervisior: values.Supervisor,
        GangMember: values.GangMember,
        OndutySign: values.OndutySign,
  ...
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/signalling/edit",
    {
      ...
      body: JSON.stringify({
        ...
        Frequency: values.Frequency,
        MaintenanceActivity: values.MaintenanceActivity,
        Supervisior: values.Supervisior,
        GangMember: values.GangMember,
        OndutySign: values.OndutySign,
        Remarks: values.Remarks,
        employee_id: user.profileid,
...
const DailyWorkReducerSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addDailyWork } = DailyWorkReducerSlice.actions;
export default DailyWorkReducerSlice.reducer;
