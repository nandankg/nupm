...
import { manPoiOpeDrillData } from "../../data/Data";
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/save", {
    ...
    body: JSON.stringify({
      ...
      from: values.from,
      to: values.to,
      totaltimtaken: values.totaltimtaken,
...
const ManPoiOpeDrillReducerSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
    slug: "manual-point-operation-drill",
    error: "",
    isSuccess: "",
  },
  reducers: {
    addManPoiOpeDrill: (state, action) => {
      console.log(action);
...
export const { addManPoiOpeDrill } = ManPoiOpeDrillReducerSlice.actions;
export default ManPoiOpeDrillReducerSlice.reducer;
