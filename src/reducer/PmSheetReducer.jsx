...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/save", {
    ...
    body: JSON.stringify({
      ...
      sup_sign: values.sup_sign,
      sup_date: values.sup_date,
      sup_time: values.sup_time,
      mtn_name: values.mtn_name,
      mtn_id: values.mtn_id,
      mtn_sign: values.mtn_sign,
      mtn_date: values.mtn_date,
      mtn_time: values.mtn_time,
      notes: values.notes,
...
export const { adddPMSheet } = PMSheetSlice.actions;
