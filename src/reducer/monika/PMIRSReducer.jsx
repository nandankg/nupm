...
export const saveData = createAsyncThunk("data/saveData", async (id) => {
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/signalling/edit",
    {
      ...
      body: JSON.stringify({
        formType: "pm-point-maintenance-record-tpd",
        status: "1",
        update_id: id,
      }),
    }
...
export const { addPMIRS } = PMIRSSlice.actions;
export default PMIRSSlice.reducer;
