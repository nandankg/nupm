...
import { EarlyMaintainData } from "../../data/Data";
...
const EarlyMaintainSlice = createSlice({
  name: "EarlyMaintainData",
  initialState: {
    loading: false,
    data: [],
...
export const { addEarlyMaintain } = EarlyMaintainSlice.actions;
export default EarlyMaintainSlice.reducer;
