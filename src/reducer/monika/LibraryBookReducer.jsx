...
import { LibraryBookData } from "../../data/Data";
...
export const saveData = createAsyncThunk("data/saveData", async (id) => {
  return fetch("https://tprosysit.com/upmrc/public/api/operation/edit", {
    ...
    body: JSON.stringify({
      formType: "library-book-issue-register",
      status: "1",
      update_id: id,
    }),
  }).then((res) => res.json());
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/save", {
    ...
    body: JSON.stringify({
      formType: "library-book-issue-register",
      titleOfTheBookIssued: values.titleOfTheBookIssued,
      uniqueNo: values.uniqueNo,
...
export const { addlibrarybook } = librarybookSlice.actions;
