...
import { CrewControlCcapData } from "../../data/Data";
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/save", {
    ...
    body: JSON.stringify({
      formType: "unplanned-to-record",
      date: values.date,
      deptt: values.department,
      purposeofreq: values.purposeofreq,
      time: values.time,
      toprovided: values.toprovided,
      reason: values.reason,
      nameofcc: values.nameofcc,
      signofcc: user.employeeid,
...
const crewcontrolccapSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addCrewcontrol } = crewcontrolccapSlice.actions;
export default crewcontrolccapSlice.reducer;
