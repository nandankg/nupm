...
import { ShiftLogBookdData } from "../../data/Data";
...
const fType = {
  telecom: "instruction-shift-log-book",
  ...
  return fetch(
    `https://tprosysit.com/upmrc/public/api/register/${deprt}/save`,
    {
      ...
      body: JSON.stringify({
        ...
        extra_remarks: values.extraremarks,
...
const shiftlogbookSlice = createSlice({
  name: "shiftlogbook",
  initialState: {
    loading: false,
    data: [],
...
export const { addShiftlog } = shiftlogbookSlice.actions;
export default shiftlogbookSlice.reducer;
