...
import { SwUpdateRegisterData } from "../../data/Data";
...
const swupateregisterSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(addData.fulfilled, (state, action) => {
      ...
      showToastOnce(action.payload.messag);
    });
...
export default swupateregisterSlice.reducer;
