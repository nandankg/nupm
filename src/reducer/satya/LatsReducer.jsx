...
import { LatsData } from "../../data/Data";
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/save", {
    ...
    body: JSON.stringify({
      ...
      time_from: values.from,
      time_to: values.to,
      result: values.result,
      remarks: values.remarks,
      employee_id: user.profileid,
      Station_name: user.station,
      TCEmploy_id: values.tcid,
      name_of_sc: values.name,
      Station_name: "up",
...
export const { addLats } = latsSlice.actions;
export default latsSlice.reducer;
