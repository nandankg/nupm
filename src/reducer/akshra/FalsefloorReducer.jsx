...
const UnderFalseFloorCleaningSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
  ...
  reducers: {
    addUnderFalseFloorCleaning: (state, action) => {
...
export const { addUnderFalseFloorCleaning } =
  UnderFalseFloorCleaningSlice.actions;
export default UnderFalseFloorCleaningSlice.reducer;
