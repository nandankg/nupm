...
import { DtrsignalsreceiptsData } from "../../data/Data";
  ...
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/afc_mainline/save",
    {
      ...
      body: JSON.stringify({
        ...
        //received_sign: user.employeeid,
        formType: "daily-transaction-register-receipt",
        employee_id: user.employeeid,
        department: user.department,
        for_whatWork: values.work,
        //receiver_sign: user.employeeid,
        unit: "AFC",
      }),
    }
  ).then((res) => res.json());
...
const dtrsignalsreceiptsSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addDtrrece } = dtrsignalsreceiptsSlice.actions;
export default dtrsignalsreceiptsSlice.reducer;
