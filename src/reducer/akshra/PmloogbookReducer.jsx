...
import { PmloogbookData } from "../../data/Data";
...
export const editData = createAsyncThunk("data/editData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/edit", {
    ...
    body: JSON.stringify({
      ...
      stn_name: values.activities,
      date: values.activities,
      month: values.month,
      activities1: values.activities,
      activities2: values.activities2,
      ...
      staff2_name: values.staff2_name,
      staff2_desg: values.staff2_desg,
      //staff2_sign: values.staff2_desg,
      staff3_name: values.staff3_name,
      staff3_desg: values.staff3_desg,
      //staff3_sign: values.staff3_sign,
      formType: "pm-logbook-monthly-tom-mainline",
...
export const { addloog } = pmloogSlice.actions;
export default pmloogSlice.reducer;
