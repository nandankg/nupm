...
export const saveData = createAsyncThunk("data/saveData", async (id) => {
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/signalling/edit",
    {
      ...
      body: JSON.stringify({
        formType: "contractual-spare-testing-register",
        status: "1",
        update_id: id,
      }),
    }
  ...
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/signalling/save",
    {
      ...
      body: JSON.stringify({
        ...
        testing_detail: values.testing_detail,
        item_serialName: values.item_serialName,
        testingLocation: values.testingLocation,
        testedFrom: values.testedFrom,
        testedTo: values.testedTo,
  ...
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/signalling/edit",
    {
      ...
      body: JSON.stringify({
        ...
        item_description: values.item_description,
        date: formatDate(new Date().toString()),
        testing_details: values.testing_details,
        dateFrom: values.dateFrom,
        dateTo: values.dateTo,
        item_serialName: values.item_serialName,
        testingLocation: values.testingLocation,
...
const ContractualSpareTestingSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addContractualSpareTesting } =
  ContractualSpareTestingSlice.actions;
export default ContractualSpareTestingSlice.reducer;
