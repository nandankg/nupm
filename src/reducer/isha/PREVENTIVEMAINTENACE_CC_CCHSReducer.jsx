...
export const saveData = createAsyncThunk("data/saveData", async (id) => {
    return fetch("https://tprosysit.com/upmrc/public/api/register/sdc/edit", {
      ...
      body: JSON.stringify({
        formType: "pm-logbook-workstations-half-yearly-sdc",
        status: "1",
        update_id: id,
      }),
    }).then((res) => res.json());
...
export const {addAfcpreventive} = pmlb9Slice.actions;
export default pmlb9Slice.reducer;
