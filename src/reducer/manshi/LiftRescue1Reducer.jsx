...
import { Lift1Data } from "../../data/Data";
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/save", {
    ...
    body: JSON.stringify({
      ...
      lift_no: values.liftno,
      from_time: values.from,
      to_time: values.to,
      timeTaken: values.totaltimetaken,
...
const Lift1Slice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
    slug: "night_lift_rescue_drill_register",
    error: "",
    isSuccess: "",
  },
  reducers: {
    addLift1: (state, action) => {
      console.log(action);
...
export const { addLift1 } = Lift1Slice.actions;
export default Lift1Slice.reducer;
