...
import { LabFaultyData } from "../../data/Data";
  ...
  return fetch(
    "https://tprosysit.com/upmrc/public/api/register/signalling/save",
    {
      ...
      body: JSON.stringify({
        ...
        EFRNo: values.EFRNo,
        EFRNo_Date: values.DateOfReplacement,
        TestingLocation: values.TestingLocation,
        DateTestingFrom: values.DateTestingFrom,
        DateTestingTo: values.DateTestingTo,
        FinalStatus: values.FinalStatus,
        TestingStaff: values.TestingStaff,
...
const LabFaultySlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addLabFaulty } = LabFaultySlice.actions;
export default LabFaultySlice.reducer;
