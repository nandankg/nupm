...
import { honoData } from "../../data/Data";
...
export const addData = createAsyncThunk("data/addData", async (values) => {
  ...
  return fetch("https://tprosysit.com/upmrc/public/api/operation/save", {
    ...
    body: JSON.stringify({
      ...
      nonexecutive: values.nonexecutive,
      gc: values.gc,
      out: values.out,
...
const HonorariumSlice = createSlice({
  name: "data",
  initialState: {
    loading: false,
    data: [],
...
export const { addHonorarium } = HonorariumSlice.actions;
export default HonorariumSlice.reducer;
