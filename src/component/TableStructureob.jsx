...
import {saveData, fetchData } from "../reducer/redux/tableDataSlice";
import {submitData} from"../reducer/store/BudgetAllotmentReducer"
...
useEffect(() => {
  ...
  const handleSave = useCallback(async (id) => {
    try {
      ...
      await dispatch(submitData({  id })).unwrap();
