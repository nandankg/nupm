...
import {saveData,fetchData} from "../reducer/store/BudgetRegisterPaymentReducer";
...
TableStructurePayment.propTypes = {
...
export default React.memo(TableStructurePayment);
